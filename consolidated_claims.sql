...
SELECT * FROM claims_intermediate where CLM_STAT='PAID' and PAT_ID IN (SELECT DISTINCT PAT_ID FROM claims_intermediate WHERE EVNT_SUB_CLSS_NM = 'PRIMARY_DIAGNOSIS')
